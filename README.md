# Pedigree_indpsamp_Poolseq

---
title: "PoolSeq - Selecting Independent Samples"
author: "Sonja Lecic"
date: "3/4/2021"
output: 
...
email: slecic8@gmail.com

date: 3/4/2021

# Calculate relatedness with kinship2
...
Use fastindep tool to break the links lower than the 0.5 threshold or in other words
exclude links for parent-offspring and siblings 

## The code

```{}

/usr/local/bin/fastindep -t 0.5 -n 100 -i allsampAdjmatrix.txt -o out.txt

less -S out.txt

grep "Set Size =  1130" out.txt > AllSampIndep.txt
...
*kinship2* version 1.8.5 for R version 4.0.3 (2020-10-10)

*FastIndep* release 1.0.0
